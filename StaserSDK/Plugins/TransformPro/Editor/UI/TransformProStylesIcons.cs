namespace UntitledGames.Transforms
{
    ...
    public class TransformProStylesIcons
    {
        ...
        public static TransformProStylesIconsSkinPair GetCustomIcons(string icon)
        {
            ...
            if (iconPersonal.StartsWith(Application.dataPath)) 
            {
                iconPersonal =  "Assets" + iconPersonal.Substring(Application.dataPath.Length);
            }
            if (iconProfessional.StartsWith(Application.dataPath)) 
            {
                iconProfessional =  "Assets" + iconProfessional.Substring(Application.dataPath.Length);
            } 
